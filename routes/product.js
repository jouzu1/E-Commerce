...
router.post("/create",verifyTokenAndAdmin, upload.single('img'),async(req,res)=>{          //upload.single('img') yang berarti hanya mengenali key 'img' di body form-data postman untuk service /product/create upload file image dan mengambil value dari key 'img' tersebut
    try {
